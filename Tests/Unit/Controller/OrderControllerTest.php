<?php
namespace Azhar\Pingandget\Tests\Unit\Controller;
...
{
    /**
     * @var \Azhar\Pingandget\Controller\OrderController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Azhar\Pingandget\Controller\OrderController::class)
    ...
    public function listActionFetchesAllOrdersFromRepositoryAndAssignsThemToView()
    {
        ...
        $orderRepository = $this->getMockBuilder(\Azhar\Pingandget\Domain\Repository\OrderRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $order = new \Azhar\Pingandget\Domain\Model\Order();
